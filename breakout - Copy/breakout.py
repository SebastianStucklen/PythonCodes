...
class Brick:
    def __init__(self,xpos,ypos,width,height):
        ...
        self.animTimer = 0
        #IMAGES
        self.brickimg = pygame.image.load("_internal/brick.png")
        self.crack = pygame.image.load("_internal/crack.png")
        self.plode1 = pygame.image.load("_internal/plode1.png")
        self.plode2 = pygame.image.load("_internal/plode2.png")
        self.plode3 = pygame.image.load("_internal/plode3.png")
