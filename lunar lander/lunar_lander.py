...
while doExit == False:
    ...
    text6 = font.render('Height:', True, (230,250,100))
    text7 = font.render(str(int(1000-yPos)),1,(230,250,100))
    ...
    pygame.draw.line(screen,(fr,fg,50),(0,20),(fuel*2,20),50)
